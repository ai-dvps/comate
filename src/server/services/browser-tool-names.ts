...
export const BROWSER_TOOL_NAMES = {
  ...
  recheckTaskOutcome: `${BROWSER_TOOL_PREFIX}recheckTaskOutcome`,
  abandonOutcomeTracking: `${BROWSER_TOOL_PREFIX}abandonOutcomeTracking`,
  acknowledgeDuplicateRisk: `${BROWSER_TOOL_PREFIX}acknowledgeDuplicateRisk`,
