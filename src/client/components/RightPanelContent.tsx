  ...
  return (
    ...
    >
      <div
        ...
        className="flex items-center gap-1 overflow-x-auto scrollbar-hide flex-shrink-0 px-2 py-1 border-b border-border/50"
        ...
        {openTabs.map((tab, index) => {
          ...
          return (
            <div
              ...
              className={cn(
                'group flex items-center gap-1.5 px-3 h-6 rounded-lg cursor-pointer text-xs transition-all whitespace-nowrap flex-shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-accent',
                isActive
