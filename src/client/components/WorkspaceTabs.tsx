    ...
    <div className="flex items-center gap-1">
      {openWorkspaces.map(ws => {
        ...
        return (
          <div
            key={ws.id}
            className={`tab-pill flex items-center gap-1.5 px-3 py-1.5 rounded-lg cursor-pointer text-xs transition-all ${
              isActive
          ...
          >
            ...
            <button
              className="ml-0.5 p-0.5 rounded opacity-0 group-hover:opacity-100 hover:bg-surface-hover hover:text-red-400 transition-all"
              onClick={(e) => {
                e.stopPropagation()
