...
describe('ChangedFilesPanel', () => {
  ...
  it('shows the full basename (wrapping allowed) and the full relative path on hover', () => {
    mockChatStore.touchedFiles.s1 = [
    ...
    expect(fileNameEl.className).toContain('shrink-0')
    expect(fileNameEl.className).not.toContain('truncate')
