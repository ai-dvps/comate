...
export default function VirtualizedMessageList({
  ...
  return (
    <div ref={parentRef} className="relative flex-1 overflow-y-auto">
      ...
      <div
        className={`p-3 max-w-3xl mx-auto w-full relative ${fontSizeClass(chatFontSize)} [&_[data-streamdown="code-block-body"]]:[font-size:inherit] [&_[data-streamdown="inline-code"]]:[font-size:inherit]`}
