...
- **The right context panel no longer crowds out conversations in narrow windows** — Its expanded width is capped at two thirds of the current window, including when restoring a saved width after the window becomes smaller.
