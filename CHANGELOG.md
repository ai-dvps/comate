...
- **Claude Code settings are grouped with their Agent** — Output style now appears directly inside the Claude Code Agent card and uses the same selector styling as the rest of Settings, making its Agent-specific scope clear.
